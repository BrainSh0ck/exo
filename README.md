...
```
docker run -p 8080:8080 -e EXO_DB_TYPE="mysql" -e EXO_DB_HOST="mysql" -e EXO_DB_NAME="exo" -e EXO_DB_USER="exo" -e EXO_DB_PASSWORD="exo" exo
```
-e EXO_DB_TYPE="mysql" -e EXO_DB_HOST="mysql.localhost" -e EXO_DB_USER="exo" -e EXO_DB_PASSWORD="my-secret-pw" exoplatform/exo-community

docker run -p 8080:8080 --env MYSQL_DATABASE=exo --env MYSQL_USER=exo --env MYSQL_PASSWORD=exo --name=exo exo
You can also use Docker Compose (see the provided `docker-compose.yml` file as an example).

docker run -p 8080:8080 -e EXO_DB_TYPE="mysql" -e EXO_DB_HOST="10.23.9.44" -e EXO_DB_NAME="exo" -e EXO_DB_USER="exo" -e EXO_DB_PASSWORD="exo" --env MYSQL_HOST="10.23.9.44" --env MYSQL_DATABASE="exo" --env MYSQL_USER="exo" --env MYSQL_PASSWORD="exo" --name=exo exo_image
